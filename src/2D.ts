...
class AbsoluteArcPath extends AbsolutePathSegment {
  ...
  constructor(params: string[], owner: Path, previous: IPathSegment|undefined) {
    ...
    this.rx = parseFloat(param === undefined ? '' : param);
    param = params.shift();
    this.ry = parseFloat(param === undefined ? '' : param);
    param = params.shift();
    this.angle = parseFloat(param === undefined ? '' : param);
    param = params.shift();
    this.arcFlag = parseFloat(param === undefined ? '' : param);
    param = params.shift();
    this.sweepFlag = parseFloat(param === undefined ? '' : param);
  }
